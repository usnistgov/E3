...
public class Lazy<A> {
     ...
     */
    @Deprecated
    public static <A, B, C> Lazy<C> lift(final Lambda2<A, B, C> f, final Lazy<A> a, final Lazy<B> b) {
     ...
     */
    @Deprecated
    public static <A, B, C, D> Lazy<D> lift(final Lambda3<A, B, C, D> f, final Lazy<A> a, final Lazy<B> b, final Lazy<C> c) {
     ...
     */
    public static <A, B, C, D, E> Lazy<E> lift(final Lambda4<A, B, C, D, E> f, final Lazy<A> a, final Lazy<B> b, final Lazy<C> c, final Lazy<D> d) {
