...
from API.objects.Analysis import calculate_discount_rate_nominal, calculate_inflation_rate
...
class AnalysisTest(TestCase):
    ...
    def test_autofill_objToReport(self):
        ...
        assert self.analysis3.objToReport == ['FlowSummary', 'MeasureSummary', 'SensitvitySummary',
                                              'UncertaintySummary', 'IRRSummary']
